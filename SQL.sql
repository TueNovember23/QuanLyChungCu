...
CREATE TABLE VechicleInvoiceDetail (
    ...
    PRIMARY KEY (VechicleInvoiceId, VehicleId),
...
INSERT INTO CommunityRoom (RoomName, RoomSize, Location)
VALUES (N'Phòng họp A', 50, N'Tầng 1');

INSERT INTO RepairInvoice (InvoiceID, InvoiceDate, InvoiceContent, TotalAmount, Status, CreatedBy)
VALUES 
(1, '2024-11-25', N'Hóa đơn sửa chữa hệ thống điều hòa', 1200000, N'Chưa thanh toán', 2),
(2, '2024-11-20', N'Hóa đơn sửa chữa đèn chiếu sáng', 500000, N'Đã thanh toán', 3),
(3, '2024-11-18', N'Hóa đơn sửa chữa hệ thống thang máy', 3500000, N'Chưa thanh toán', 1);

INSERT INTO Equipment (EquipmentID, EquipmentName, Discription, AreaId, Status, IsDeleted)
VALUES 
(10, N'Hệ thống đèn chiếu sáng', N'Đèn chiếu sáng hành lang tầng 1', 1, N'Hỏng', 0),
(11, N'Hệ thống máy bơm nước', N'Máy bơm nước tầng hầm', 1, N'Hoạt động', 0),
(12, N'Hệ thống điều hòa', N'Điều hòa trong phòng họp', 2, N'Hỏng', 0);

INSERT INTO MalfuntionEquipment (RepairInvoiceId, EquipmentId, Description, SolvingMethod, RepairPrice)
VALUES
(1, 1, N'Hỏng bóng đèn', N'Thay bóng đèn LED mới', 200000),
(2, 2, N'Lỗi cục nóng', N'Thay quạt cục nóng', 500000);

INSERT INTO Vehicle (VehicleId, VehicleOwner, Status, ApartmentId, VehicleCategoryId)
VALUES
    ('59-AA-12345', N'Nguyễn Văn A', N'Đang gửi', 1, 2), 
    ('30-AC-67890', N'Nguyễn Thị B', N'Đang gửi', 1, 3);

INSERT INTO Invoice (CreatedBy, Month, Year, TotalAmount, Status)
VALUES (2, 12, 2024, 1559460, N'Chưa thanh toán'),
    (2, 11, 2024, 1620000, N'Đã thanh toán');

INSERT INTO VechicleInvoice (TotalAmount, InvoiceId, ApartmentId)
VALUES 
    (1100000, 1, 1), 
    (1100000, 2, 1);

INSERT INTO VechicleInvoiceDetail (VechicleInvoiceId, VehicleId, Price)
VALUES
    (1, '59-AA-12345', 100000), 
    (1, '30-AC-67890', 1000000),
    (2, '59-AA-12345', 100000), 
    (2, '30-AC-67890', 1000000); 

INSERT INTO WaterFee (CreatedDate, Level1, Price1, Level2, Price2, Price3)
VALUES
(GETDATE(), 10, 5973 , 10, 7052, 10000);

INSERT INTO WaterInvoice (StartIndex, EndIndex, NumberOfPeople, TotalAmount, InvoiceId, ApartmentId, WaterFeeId)
VALUES
(0, 20, 4, 119460, 1, 1, 1),
(20, 35, 3, 180000, 2, 1, 1);

INSERT INTO ManagementFee (CreatedDate, Price)
VALUES
(GETDATE(), 4000);
INSERT INTO ManagementFeeInvoice (Price, TotalAmount, InvoiceId, ApartmentId, ManagementFeeHistoryId)
VALUES
(0,384000, 1, 1, 1),
(0,384000, 2, 1, 1);
